...
**עיצוב ממשק:** האפליקציה משתמשת ב-**Fluent UI** (שפת העיצוב של Windows) על Windows, ו-**Material Design 3** על פלטפורמות אחרות, כדי לספק חוויה מקורית לכל פלטפורמה. ראו [מדריך המיגרציה](docs/FLUENT_MIGRATION.md) למידע נוסף.
